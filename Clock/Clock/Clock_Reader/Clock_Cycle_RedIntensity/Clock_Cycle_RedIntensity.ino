...
boolean setHourColour(int value, int pixel) {
  ...
  switch (value) {
    ...
    case 1:
      ...
      break;
    case 2:
      strip.setPixelColor(pixel, 255, 204, 204); //light green
      strip.show();
      break;
    case 3:
      strip.setPixelColor(pixel, 255, 153, 153); //yellow
      strip.show();
      break;
    case 4:
      strip.setPixelColor(pixel, 255, 102, 102); //yellow - orange
      strip.show();
      break;
    case 5:
      strip.setPixelColor(pixel, 255, 51, 51); // vibrant orange
      strip.show();
      break;
    case 6:
